  ...
  ({
    ...
    return (
      ...
      <div
        ...
        // Hover is not available on a phone, so the press answers there instead of nothing at all.
        className="group flex cursor-pointer items-start gap-3 rounded-md px-2 py-2 transition-colors duration-150 pointer-coarse:py-3 hover:bg-card active:bg-card has-focus-visible:bg-card"
      >
        <Checkbox
          checked={done}
