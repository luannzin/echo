...
export const en = {
  ...
  editor: {
    ...
    find: "Find in this note",
    findPlaceholder: "Find",
    findNext: "Next match",
    findPrevious: "Previous match",
    closeFind: "Close find",
    noMatches: "No matches",
    matchCount: (at: number, total: number) => `${at} of ${total}`,
  ...
  arrival: {
    ...
    checklist: {
      ...
      showMe: (label: string) => `Show me: ${label}`,
      wrote: "Write a line, press Enter",
      read: "See what echo read in it",
      found: "Search for it in your own words",
      placed: "File a note from the Inbox",
      settled: "Set echo up the way you like",
    },
  },
