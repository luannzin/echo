...
export const learningEventSchema = z.object({
  ...
  kind: z.enum([
    ...
    "destination",
    "category",
    /** Two of the reader's words that mean the same thing. The subject is the pair, folded and sorted. */
    "alias",
    /** A word echo read a note as being about. Taking it off is how the reader says otherwise. */
    "concept",
  ]),
